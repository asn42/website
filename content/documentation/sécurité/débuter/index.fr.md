...
Discutez avec des gens qui s'intéressent à la sécurité ([nous](@/contact/index.fr.md), par exemple :D). Posez des questions, mais ne croyez pas tout ce qu'on vous dit.
...
Synacktiv nous avait envoyé un ancien étudiant et un stagiaire de 42 pour en parler : [Comment qu'est ce qu'on flag ? Introduction aux CTF](@/activités/conférences/introduction_ctf/index.fr.md).

Il existe [des sites pour s'entrainer](@/documentation/sécurité/ressources/index.fr.md#challenges-et-entrainement) où les challenges restent disponibles assez longtemps, mais il y a aussi des CTFs ponctuels que l'on peut généralement trouver sur [CTFtime.org](https://ctftime.org/).
